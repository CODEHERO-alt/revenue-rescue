    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <section className="py-20 px-6 bg-card">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="grid sm:grid-cols-3 gap-6">
            {[
              { stat: "10–20%", label: "Typical efficiency recovery" },
              { stat: "2–3 days", label: "Full delivery timeline" },
              { stat: "30 days", label: "Average payback period" },
            ].map(({ stat, label }) => (
              <div key={label} className="p-6 rounded-xl bg-background border border-border">
                <p className="text-3xl font-black text-gradient-gold mb-2">{stat}</p>
